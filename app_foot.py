...
st.set_page_config(page_title="BIENVENUE SUR Master Predicts", layout="centered", page_icon="⚽")
...
st.markdown(f"""
    <div style="text-align: center; margin-top: 30px; padding-bottom: 50px;">
        ...
        <p style="font-weight: bold; color: white; letter-spacing: 1px;">HEMERY DALLAH </p>
    </div>
    """, unsafe_allow_html=True)
